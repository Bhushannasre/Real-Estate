...
function Header(){
  ...
  transition={{ duration: 1.5 }}
        className="container mx-auto text-white text-center flex flex-col items-center justify-center h-full md:px-20 lg:px-32">
<h2 className='text-5xl sm:text-5xl md:text-[80px] max-w-3xl font-semibold pt-20 leading-tight'>
