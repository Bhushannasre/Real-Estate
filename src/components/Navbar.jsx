    ...
    return (
     <div className="absolute top-0 left-0 w-full z-10">
        <div className='container mx-auto flex justify-between items-center px-6 py-4 md:px-20 lg:px-32 bg-transparent'>
          ...
          <div className={`md:hidden ${showMenu ? 'fixed w-full':'h-0 w-0'} top-0 right-0 bottom-0 overflow-hidden bg-white transition-all duration-300 ease-in-out z-20 `}>
        <div className='flex justify-end p-6 cursor-pointer md:hidden'>
            <img onClick={()=>setShowMenu(false)} src={assets.cross_icon} className='w-6 ' alt="cross icon" />
